            ...
            <form action="checkout.php" method="POST">
                ...
                <div class="input-field">
                    ...
                    <select id="shipping_method" name="shipping_method" required>
                        <option value="courier">Doručení kurýrem na adresu - ZDARMA</option>
                        <option value="pickup">Osobní odběr (na adrese Milevská 2094/3, 140 00 Praha 4 - Krč) - ZDARMA</option>
                    </select>
                </div>
