...
$username_db = "student1";  // změněno na jiný název pro připojení k databázi
$password = "spsnet";

$connOrders = new mysqli($servername, $username_db, $password, "vyuka1");
if ($connOrders->connect_error) {
    die("Connection to objednavky failed: " . $connOrders->connect_error);
}

$connProducts = new mysqli($servername, $username_db, $password, "vyuka1");
